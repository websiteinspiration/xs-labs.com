<p>
    <ul class="floating-list">
        <li><a href="#apple-pre-mac">Apple - Pre-Macintosh</a></li>
        <li><a href="#apple-old-world">Apple - Macintosh (Old World)</a></li>
        <li><a href="#apple-clones">Macintosh Clones</a></li>
        <li><a href="#apple-new-world">Apple - Macintosh (New World)</a></li>
        <li><a href="#apple-intel">Apple - Intel</a></li>
        <li><a href="#apple-ios">Apple - iDevices</a></li>
        <li><a href="#apple-displays">Apple - Displays</a></li>
        <li><a href="#apple-miscellaneous">Apple - Miscellaneous</a></li>
        <li><a href="#other-computers">Other Computers</a></li>
        <li><a href="#parts-rare">Computer Parts - Rare Stuff</a></li>
        <li><a href="#parts-processors">Computer Parts - Processors</a></li>
        <li><a href="#other-accessories">Other Accessories</a></li>
    </ul>
</p>
<a name="apple-pre-mac"></a>
...
<div class="project-box-group">
    <div class="project-box-left">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">1MHz / MOS Technology - SynerTek 6502</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">8 bits</div>
                <div class="clearer"></div>
                <div class="col-35">RAM:</div>
                <div class="col-65">64KB - 128KB (with expansion card)</div>
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">None (floppy only)</div>
                <div class="clearer"></div>
                <div class="col-35">Graphics:</div>
                <div class="col-65">N/A</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://www.apple-history.com/aiie">Apple History</a></div>
            </div>
        </p>
    </div>
    <div class="project-box-right">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">1MHz / SynerTek 65C02</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">8 bits</div>
                <div class="clearer"></div>
                <div class="col-35">RAM:</div>
                <div class="col-65">128KB</div>
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">None (floppy only)</div>
                <div class="clearer"></div>
                ...
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://www.apple-history.com/aiic">Apple History</a></div>
            </div>
        </p>
    </div>
</div>
<div class="project-box-group">
    <div class="project-box-left">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">2.8MHz / Western Design Center 65C816</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">16 bits</div>
                <div class="clearer"></div>
                <div class="col-35">RAM:</div>
                <div class="col-65">256KB (max. 8MB)</div>
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">None (floppy only)</div>
                <div class="clearer"></div>
                ...
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://www.apple-history.com/aiigs">Apple History</a></div>
            </div>
        </p>
    </div>
</div>
<a name="apple-old-world"></a>
...
<div class="project-box-group">
    <div class="project-box-left">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">8MHz / Motorola MC68000</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits</div>
                <div class="clearer"></div>
                <div class="col-35">RAM:</div>
                <div class="col-65">1MB (max. 4MB)</div>
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">None - 40MB (optional)</div>
                <div class="clearer"></div>
                <div class="col-35">Graphics:</div>
                <div class="col-65">N/A</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://www.apple-history.com/se">Apple History</a></div>
            </div>
        </p>
    </div>
    <div class="project-box-right">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">16MHz / Motorola MC68000</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits</div>
                <div class="clearer"></div>
                <div class="col-35">RAM:</div>
                <div class="col-65">1MB (max. 8MB)</div>
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">None - 40MB (optional)</div>
                <div class="clearer"></div>
                ...
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://www.apple-history.com/portable">Apple History</a></div>
            </div>
        </p>
    </div>
</div>
<div class="project-box-group">
    <div class="project-box-left">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">25MHz / Motorola MC68030</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits</div>
                <div class="clearer"></div>
                <div class="col-35">RAM:</div>
                <div class="col-65">4MB (max. 14MB)</div>
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">40MB - 120MB</div>
                <div class="clearer"></div>
                <div class="col-35">Graphics:</div>
                <div class="col-65">N/A</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://www.apple-history.com/160">Apple History</a></div>
            </div>
        </p>
    </div>
    <div class="project-box-right">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">16MHz / Motorola MC68030</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits</div>
                <div class="clearer"></div>
                <div class="col-35">RAM:</div>
                <div class="col-65">2MB (max. 10MB)</div>
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">40MB - 160MB</div>
                <div class="clearer"></div>
                <div class="col-35">Graphics:</div>
                <div class="col-65">N/A</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://www.apple-history.com/colorclassic">Apple History</a></div>
            </div>
        </p>
    </div>
</div>
    ...
    <div class="project-box-left">
        ...
        <p>
            <div class="row">
                ...
                <div class="clearer"></div>
                <div class="col-35">RAM:</div>
                <div class="col-65">4MB (max. 36MB)</div>
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">80MB - 160MB</div>
                <div class="clearer"></div>
                <div class="col-35">Graphics:</div>
                <div class="col-65">512KB - 768KB</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://www.apple-history.com/lciii">Apple History</a></div>
            </div>
        </p>
    </div>
    <div class="project-box-right">
...
<div class="project-box-group">
    <div class="project-box-left">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">33MHz / Motorola MC68030</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits</div>
                <div class="clearer"></div>
                ...
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://www.apple-history.com/colorclassicii">Apple History</a></div>
            </div>
        </p>
    </div>
    <div class="project-box-right">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">60MHz - 66MHz / PowerPC 601</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits</div>
                <div class="clearer"></div>
                <div class="col-35">RAM:</div>
                <div class="col-65">8MB (max. 72MB)</div>
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">500MB</div>
                <div class="clearer"></div>
                <div class="col-35">Graphics:</div>
                <div class="col-65">1MB DRAM</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://apple-history.com/6100">Apple History</a></div>
            </div>
        </p>
    </div>
</div>
<div class="project-box-group">
    <div class="project-box-left">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">66MHz - 80MHz / PowerPC 601</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits</div>
                <div class="clearer"></div>
                <div class="col-35">RAM:</div>
                <div class="col-65">8MB (max. 136MB)</div>
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">250MB - 700MB</div>
                <div class="clearer"></div>
                <div class="col-35">Graphics:</div>
                <div class="col-65">1MB DRAM</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://apple-history.com/7100">Apple History</a></div>
            </div>
        </p>
    </div>
    <div class="project-box-right">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">25MHz / Motorola MC68LC040</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits</div>
                <div class="clearer"></div>
                ...
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">130MB - 320MB</div>
                <div class="clearer"></div>
                <div class="col-35">Graphics:</div>
                <div class="col-65">N/A</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://www.apple-history.com/520">Apple History</a></div>
            </div>
        </p>
    </div>
</div>
<div class="project-box-group">
    <div class="project-box-left">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">33MHz / Motorola MC68040</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits</div>
                <div class="clearer"></div>
                ...
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">250MB - 500MB</div>
                <div class="clearer"></div>
                <div class="col-35">Graphics:</div>
                <div class="col-65">1MB</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://www.apple-history.com/630">Apple History</a></div>
            </div>
        </p>
    </div>
    <div class="project-box-right">
        ...
        <p>
            <div class="row">
                ...
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">240MB - 500MB</div>
                <div class="clearer"></div>
                <div class="col-35">Graphics:</div>
                <div class="col-65">N/A</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://www.apple-history.com/150">Apple History</a></div>
            </div>
        </p>
    </div>
</div>
<div class="project-box-group">
    <div class="project-box-left">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">75MHz / PowerPC 603</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits</div>
                <div class="clearer"></div>
                <div class="col-35">RAM:</div>
                <div class="col-65">4MB (max. 64MB)</div>
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">500MB</div>
                <div class="clearer"></div>
                ...
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://www.apple-history.com/5200">Apple History</a></div>
            </div>
        </p>
    </div>
    <div class="project-box-right">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">117MHz - 133MHz - 166MHz / PowerPC 603</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits</div>
                <div class="clearer"></div>
                <div class="col-35">RAM:</div>
                <div class="col-65">16MB (max. 64MB)</div>
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">750MB - 2GB</div>
                <div class="clearer"></div>
                <div class="col-35">Graphics:</div>
                <div class="col-65">512KB</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://www.apple-history.com/1400">Apple History</a></div>
            </div>
        </p>
    </div>
</div>
<a name="apple-clones"></a>
...
<div class="project-box-group">
    <div class="project-box-left">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">225MHz / PowerPC 604e</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits</div>
                <div class="clearer"></div>
                <div class="col-35">RAM:</div>
                <div class="col-65">16MB (max. 1024MB)</div>
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">2GB - 8GB</div>
                <div class="clearer"></div>
                <div class="col-35">Graphics:</div>
                <div class="col-65">8MB</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65">N/A</div>
            </div>
...
<div class="project-box-group">
    <div class="project-box-left">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">233MHz / G3 - PowerPC 750</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits</div>
                <div class="clearer"></div>
                <div class="col-35">RAM:</div>
                <div class="col-65">32MB (max. 128MB)</div>
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">4GB</div>
                <div class="clearer"></div>
                <div class="col-35">Graphics:</div>
                <div class="col-65">2MB - 6MB SGRAM</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://www.apple-history.com/imac">Apple History</a></div>
            </div>
        </p>
    </div>
    <div class="project-box-right">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">266MHz / G3 - PowerPC 750</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits</div>
                <div class="clearer"></div>
                <div class="col-35">RAM:</div>
                <div class="col-65">32MB (max. 256MB)</div>
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">6GB</div>
                <div class="clearer"></div>
                <div class="col-35">Graphics:</div>
                <div class="col-65">6MB SGRAM</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://www.apple-history.com/imacrevc">Apple History</a></div>
            </div>
        </p>
    </div>
</div>
<div class="project-box-group">
    ...
    <div class="project-box-right">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">300MHz / G3 - PowerPC 750</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits</div>
                <div class="clearer"></div>
                <div class="col-35">RAM:</div>
                <div class="col-65">32MB (max. 288MB)</div>
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">6GB</div>
                <div class="clearer"></div>
                <div class="col-35">Graphics:</div>
                <div class="col-65">4MB</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://www.apple-history.com/ibook">Apple History</a></div>
            </div>
        </p>
    </div>
</div>
<div class="project-box-group">
    <div class="project-box-left">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">450MHz / G4 - PowerPC 7400</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits</div>
                <div class="clearer"></div>
                <div class="col-35">RAM:</div>
                <div class="col-65">256MB (max. 1.5GB - 2GB)</div>
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">20GB</div>
                <div class="clearer"></div>
                <div class="col-35">Graphics:</div>
                <div class="col-65">16MB</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://www.apple-history.com/g4agp">Apple History</a></div>
            </div>
        </p>
    </div>
    <div class="project-box-right">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">400MHz - 500MHz / G3 - PowerPC 750</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits</div>
                <div class="clearer"></div>
                <div class="col-35">RAM:</div>
                <div class="col-65">64MB (max. 512MB)</div>
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">6GB - 18GB</div>
                <div class="clearer"></div>
                <div class="col-35">Graphics:</div>
                <div class="col-65">8MB</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://www.apple-history.com/pg3sfirewire">Apple History</a></div>
            </div>
        </p>
    </div>
</div>
<div class="project-box-group">
    <div class="project-box-left">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">400MHz / G3 - PowerPC 750</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits</div>
                <div class="clearer"></div>
                <div class="col-35">RAM:</div>
                <div class="col-65">64MB (max. 1GB)</div>
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">10GB</div>
                <div class="clearer"></div>
                <div class="col-35">Graphics:</div>
                <div class="col-65">8MB SGRAM</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://www.apple-history.com/dv2000">Apple History</a></div>
            </div>
        </p>
    </div>
    <div class="project-box-right">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">500MHz / G3 - PowerPC 750</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits</div>
                <div class="clearer"></div>
                <div class="col-35">RAM:</div>
                <div class="col-65">128MB (max. 1GB)</div>
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">30GB</div>
                <div class="clearer"></div>
                <div class="col-35">Graphics:</div>
                <div class="col-65">8MB SGRAM</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://www.apple-history.com/dvse2000">Apple History</a></div>
            </div>
        </p>
    </div>
</div>
<div class="project-box-group">
    ...
    <div class="project-box-right">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">450MHz - 500MHz / G4 - PowerPC 7400</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits</div>
                <div class="clearer"></div>
                <div class="col-35">RAM:</div>
                <div class="col-65">128MB (max. 1.5GB)</div>
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">20GB - 30GB - 60GB</div>
                <div class="clearer"></div>
                <div class="col-35">Graphics:</div>
                <div class="col-65">16MB - 32MB</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://www.apple-history.com/g4cube">Apple History</a></div>
            </div>
        </p>
    </div>
</div>
<div class="project-box-group">
    <div class="project-box-left">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">1.42GHz / G4 - PowerPC 7447a</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits</div>
                <div class="clearer"></div>
                <div class="col-35">RAM:</div>
                <div class="col-65">256MB (max. 1GB)</div>
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">80GB - 160GB</div>
                <div class="clearer"></div>
                <div class="col-35">Graphics:</div>
                <div class="col-65">64MB</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://www.apple-history.com/emac_mid05">Apple History</a></div>
            </div>
        </p>
    </div>
    <div class="project-box-right">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">2x2.7Ghz / G5 - PowerPC 970FX</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">64 bits</div>
                <div class="clearer"></div>
                <div class="col-35">RAM:</div>
                <div class="col-65">2GB (max. 8GB)</div>
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">400GB</div>
                <div class="clearer"></div>
                <div class="col-35">Graphics:</div>
                <div class="col-65">256MB</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://www.apple-history.com/g5_early_05">Apple History</a></div>
            </div>
        </p>
    </div>
</div>
<div class="project-box-group">
    <div class="project-box-left">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">1.25Ghz / G4 - PowerPC 7447A</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits</div>
                <div class="clearer"></div>
                <div class="col-35">RAM:</div>
                <div class="col-65">512MB (max. 1GB)</div>
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">40GB - 80GB</div>
                <div class="clearer"></div>
                <div class="col-35">Graphics:</div>
                <div class="col-65">32MB</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://www.apple-history.com/mac_mini">Apple History</a></div>
            </div>
        </p>
    </div>
</div>
<a name="apple-intel"></a>
<h2>Apple - Intel</h2>
<div class="project-box-group">
    <div class="project-box-left">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">Intel Core Duo (T2xxx)</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">1.83GHz - 2.0GHz - 2.16GHz</div>
                <div class="clearer"></div>
                <div class="col-35">RAM:</div>
                <div class="col-65">2GB</div>
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">80GB - 100GB</div>
                <div class="clearer"></div>
                <div class="col-35">Graphics:</div>
                <div class="col-65">128MB - 256MB GDDR3</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://www.apple-history.com/mbp">Apple History</a></div>
            </div>
        </p>
    </div>
    <div class="project-box-right">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">2.8GHz / Intel Mobile Core 2 Duo (T9xxx)</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">64 bits</div>
                <div class="clearer"></div>
                <div class="col-35">RAM:</div>
                <div class="col-65">8GB</div>
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">512GB</div>
                <div class="clearer"></div>
                <div class="col-35">Graphics:</div>
                <div class="col-65">512MB GDDR3 + 256MB shared</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://www.apple-history.com/mbp_17_mid_09">Apple History</a></div>
            </div>
        </p>
    </div>
</div>
<div class="project-box-group">
    <div class="project-box-left">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">2.3GHz / Intel Core i7 (2760QM, 2860QM) ("Sandy Bridge")</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">64 bits</div>
                <div class="clearer"></div>
                ...
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">512GB SSD</div>
                <div class="clearer"></div>
                <div class="col-35">Graphics:</div>
                <div class="col-65">1GB GDDR5 + 283MB shared</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://www.apple-history.com/mbp_17_early_11">Apple History</a></div>
            </div>
        </p>
    </div>
</div>
...
<div class="project-box-group">
    <div class="project-box-left">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">400MHz / Samsung S3C6400 (ARM11 core)</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits</div>
                <div class="clearer"></div>
                <div class="col-35">RAM:</div>
                <div class="col-65">128MB</div>
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">8GB - 16GB</div>
                <div class="clearer"></div>
                <div class="col-35">Graphics:</div>
                <div class="col-65">N/A</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://www.apple-history.com/iphone_3g">Apple History</a></div>
            </div>
        </p>
    </div>
    <div class="project-box-right">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">600MHz / Samsung S5PC100 (ARM Cortex-A8 core)</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits</div>
                <div class="clearer"></div>
                ...
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">16GB - 32GB</div>
                <div class="clearer"></div>
                <div class="col-35">Graphics:</div>
                <div class="col-65">N/A</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://www.apple-history.com/iphone_3gs">Apple History</a></div>
            </div>
        </p>
    </div>
</div>
<div class="project-box-group">
    <div class="project-box-left">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">800MHz / Apple A4 (ARM Cortex-A8)</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits</div>
                <div class="clearer"></div>
                <div class="col-35">RAM:</div>
                <div class="col-65">512MB</div>
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">16GB - 32GB</div>
                <div class="clearer"></div>
                ...
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://www.apple-history.com/iphone_4">Apple History</a></div>
            </div>
        </p>
    </div>
    <div class="project-box-right">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">1Ghz / Apple A4 (ARM Cortex-A8)</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits</div>
                <div class="clearer"></div>
                <div class="col-35">RAM:</div>
                <div class="col-65">156MB</div>
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">16GB - 32GB - 64GB</div>
                <div class="clearer"></div>
                <div class="col-35">Graphics:</div>
                <div class="col-65">N/A</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://www.apple-history.com/ipad">Apple History</a></div>
            </div>
        </p>
    </div>
</div>
<div class="project-box-group">
    <div class="project-box-left">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">1Ghz / Apple A5 (ARM Cortex-A9)</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits</div>
                <div class="clearer"></div>
                ...
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://www.apple-history.com/ipad_2">Apple History</a></div>
            </div>
        </p>
    </div>
    <div class="project-box-right">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">800MHz / Apple A5 (ARM Cortex-A9)</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits</div>
                <div class="clearer"></div>
                ...
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://www.apple-history.com/iphone_4s">Apple History</a></div>
            </div>
        </p>
    </div>
</div>
<div class="project-box-group">
    <div class="project-box-left">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">1Ghz / Apple A5X (ARM Cortex-A9)</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits</div>
                <div class="clearer"></div>
                <div class="col-35">RAM:</div>
                <div class="col-65">1GB</div>
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">16GB - 32GB - 64GB</div>
                <div class="clearer"></div>
                ...
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://www.apple-history.com/ipad_3">Apple History</a></div>
            </div>
        </p>
    </div>
    <div class="project-box-right">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">1.3Ghz / Apple A6</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits</div>
                <div class="clearer"></div>
                <div class="col-35">RAM:</div>
                <div class="col-65">1.0GB</div>
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">16GB - 32GB - 64GB</div>
                <div class="clearer"></div>
...
<div class="project-box-group">
    ...
    <div class="project-box-right">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">1.3Ghz Dual-Core / Apple A7 (Cyclone)</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">64 bits</div>
                <div class="clearer"></div>
    ...
    <div class="project-box-left">
        ...
        <p>
            <div class="row">
                ...
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">16GB - 32GB - 64GB - 128GB</div>
                <div class="clearer"></div>
                <div class="col-35">Graphics:</div>
                <div class="col-65">N/A</div>
                <div class="clearer"></div>
...
<div class="project-box-group">
    <div class="project-box-left">
        ...
        <p>
            <div class="row">
                <div class="col-35">Type:</div>
                <div class="col-65">CRT (Diamondtron)</div>
                <div class="clearer"></div>
                <div class="col-35">Connector:</div>
                <div class="col-65">Apple Display Connector (ADC)</div>
                <div class="clearer"></div>
                <div class="col-35">Resolution:</div>
                <div class="col-65">1600x1200</div>
                <div class="clearer"></div>
                <div class="col-35">Colors:</div>
                <div class="col-65">16.7 Million</div>
                <div class="clearer"></div>
                <div class="col-35">DPI:</div>
                <div class="col-65">85</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65">N/A</div>
            </div>
    ...
    <div class="project-box-right">
        ...
        <p>
            <div class="row">
                <div class="col-35">Type:</div>
                <div class="col-65">LCD</div>
                <div class="clearer"></div>
                <div class="col-35">Connector:</div>
                <div class="col-65">Apple Display Connector (ADC)</div>
                <div class="clearer"></div>
                <div class="col-35">Resolution:</div>
                <div class="col-65">1024x768</div>
                <div class="clearer"></div>
                <div class="col-35">Colors:</div>
                <div class="col-65">16.7 Million</div>
                <div class="clearer"></div>
                <div class="col-35">DPI:</div>
                <div class="col-65">96</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65">N/A</div>
            </div>
...
<div class="project-box-group">
    <div class="project-box-left">
        ...
        <div style="float: right;" class="photo-credit">
            ...
            Photo: Mac Users Guide
        </div>
        <p>
            <div class="row">
                <div class="col-35">Image:</div>
                <div class="col-65">24 bits</div>
                <div class="clearer"></div>
                <div class="col-35">Resolution:</div>
                <div class="col-65">640 x 480</div>
                <div class="clearer"></div>
                <div class="col-35">Memory:</div>
                <div class="col-65">1MB Flash EPROM</div>
                <div class="clearer"></div>
                <div class="col-35">Lens:</div>
                <div class="col-65">8 mm</div>
                <div class="clearer"></div>
                <div class="col-35">Aperture:</div>
                <div class="col-65">f/2.0 to f/16</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://en.wikipedia.org/wiki/Apple_QuickTake">Wikipedia</a></div>
            </div>
        </p>
    </div>
    <div class="project-box-right">
...
<div class="project-box-group">
    <div class="project-box-left">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">66MHz / PowerPC 603</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits</div>
                <div class="clearer"></div>
                <div class="col-35">RAM:</div>
                <div class="col-65">6MB (combined with storage)</div>
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">6MB (combined with RAM)</div>
                <div class="clearer"></div>
                <div class="col-35">Graphics:</div>
                <div class="col-65">128KB NVRAM</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://en.wikipedia.org/wiki/Apple_Bandai_Pippin">Apple History</a></div>
            </div>
        </p>
    </div>
    <div class="project-box-right">
        ...
        <p>
            <div class="row">
                ...
                <div class="clearer"></div>
                <div class="col-35">Memory:</div>
                <div class="col-65">2MB or 4MB SmartMedia Card</div>
                <div class="clearer"></div>
                <div class="col-35">Lens:</div>
                <div class="col-65">8 mm</div>
                <div class="clearer"></div>
                <div class="col-35">Aperture:</div>
                <div class="col-65">f/2.0 to f/8</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://en.wikipedia.org/wiki/Apple_QuickTake">Wikipedia</a></div>
            </div>
...
<div class="project-box-group">
    <div class="project-box-left">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">25MHz / ARM 710a</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits</div>
                <div class="clearer"></div>
                ...
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">2MB Flash</div>
                <div class="clearer"></div>
                <div class="col-35">Graphics:</div>
                <div class="col-65">N/A</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://en.wikipedia.org/wiki/EMate_300">Wikipedia</a></div>
            </div>
        </p>
    </div>
    <div class="project-box-right">
        ...
        <p>
            <div class="row">
                <div class="col-35">Codename:</div>
                <div class="col-65">Kodiak</div>
                <div class="clearer"></div>
                <div class="col-35">Year:</div>
                <div class="col-65">2000</div>
                <div class="clearer"></div>
                <div class="col-35">Build:</div>
                <div class="col-65">2E14</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://en.wikipedia.org/wiki/Mac_OS_X_Public_Beta">Wikipedia</a></div>
            </div>
        </p>
    </div>
</div>
<a name="other-computers"></a>
...
<div class="project-box-group">
    <div class="project-box-left">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">AMD Athlon XP</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits</div>
                <div class="clearer"></div>
                <div class="col-35">RAM:</div>
                <div class="col-65">Unknown</div>
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">Unknown</div>
                <div class="clearer"></div>
    ...
    <div class="project-box-right">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">1.4GHz / Intel Pentium III</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits</div>
                <div class="clearer"></div>
                <div class="col-35">RAM:</div>
                <div class="col-65">2GB (max. 4GB)</div>
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">1x18.2GB + 1x36.4GB</div>
                <div class="clearer"></div>
                <div class="col-35">Graphics:</div>
                <div class="col-65">N/A</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://en.wikipedia.org/wiki/Primergy">Wikipedia</a></div>
            </div>
        </p>
    </div>
</div>
<div class="project-box-group">
    <div class="project-box-left">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">933MHz / Intel Pentium III</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits</div>
                <div class="clearer"></div>
    ...
    <div class="project-box-left">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">2x2.8GHz / Intel Xeon</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">64 bits</div>
                <div class="clearer"></div>
                <div class="col-35">RAM:</div>
                <div class="col-65">2GB (max. 16GB)</div>
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">1x400GB</div>
                <div class="clearer"></div>
                <div class="col-35">Graphics:</div>
                <div class="col-65">16MB SDRAM</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://en.wikipedia.org/wiki/Dell_PowerEdge">Wikipedia</a></div>
            </div>
        </p>
    </div>
</div>
...
<div class="project-box-group">
    <div class="project-box-left">
        ...
        <p>
            <div class="row">
                <div class="col-35">CPU:</div>
                <div class="col-65">1.66GHz / Intel Atom N455</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits</div>
                <div class="clearer"></div>
                ...
                <div class="clearer"></div>
                <div class="col-35">Storage:</div>
                <div class="col-65">250GB</div>
                <div class="clearer"></div>
                <div class="col-35">Graphics:</div>
                <div class="col-65">256MB shared</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65">N/A</div>
            </div>
...
<div class="project-box-group">
    <div class="project-box-left">
        ...
        <p>
            <div class="row">
                <div class="col-35">Year:</div>
                <div class="col-65">1976</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://en.wikipedia.org/wiki/Cray-1">Wikipedia</a></div>
            </div>
        </p>
    </div>
    <div class="project-box-right">
        ...
        <p>
            <div class="row">
                <div class="col-35">Year:</div>
                <div class="col-65">1982</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://en.wikipedia.org/wiki/Cray_X-MP">Wikipedia</a></div>
            </div>
        </p>
    </div>
</div>
<div class="project-box-group">
    <div class="project-box-left">
        ...
        <p>
            <div class="row">
                <div class="col-35">Year:</div>
                <div class="col-65">1985</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://en.wikipedia.org/wiki/Cray-2">Wikipedia</a></div>
            </div>
        </p>
    </div>
    <div class="project-box-right">
    ...
    <div class="project-box-left">
        ...
        <p>
            <div class="row">
                ...
                <div class="col-65">P4004</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">4 bits</div>
                <div class="clearer"></div>
                <div class="col-35">Frequency:</div>
                <div class="col-65">0.74 MHz</div>
                <div class="clearer"></div>
                <div class="col-35">Serial:</div>
                <div class="col-65">2853B</div>
                <div class="clearer"></div>
                <div class="col-35">Year:</div>
                <div class="col-65">1973</div>
                <div class="clearer"></div>
                <div class="col-35">Origin:</div>
                <div class="col-65">Unknown</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://en.wikipedia.org/wiki/Intel_4004">Wikipedia</a></div>
            </div>
        </p>
    </div>
    <div class="project-box-right">
        ...
        <p>
            <div class="row">
                ...
                <div class="clearer"></div>
                <div class="col-35">Serial:</div>
                <div class="col-65">2934W</div>
                <div class="clearer"></div>
                <div class="col-35">Year:</div>
                <div class="col-65">1980</div>
                <div class="clearer"></div>
                <div class="col-35">Origin:</div>
                <div class="col-65">Unknown</div>
                <div class="clearer"></div>
...
<div class="project-box-group">
    <div class="project-box-left">
        ...
        <p>
            <div class="row">
                <div class="col-35">Model:</div>
                <div class="col-65">C8008-1</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">8 bits</div>
                <div class="clearer"></div>
                <div class="col-35">Frequency:</div>
                <div class="col-65">0.8 MHz</div>
                <div class="clearer"></div>
                <div class="col-35">Serial:</div>
                <div class="col-65">5694A</div>
                <div class="clearer"></div>
                <div class="col-35">Year:</div>
                <div class="col-65">1977</div>
                <div class="clearer"></div>
                <div class="col-35">Origin:</div>
                <div class="col-65">Unknown</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://en.wikipedia.org/wiki/Intel_8008">Wikipedia</a></div>
            </div>
        </p>
    </div>
    <div class="project-box-right">
        ...
        <p>
            <div class="row">
                <div class="col-35">Model:</div>
                <div class="col-65">C8080A</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">8 bits</div>
                <div class="clearer"></div>
                <div class="col-35">Frequency:</div>
                <div class="col-65">2.00 MHz</div>
                <div class="clearer"></div>
                <div class="col-35">Serial:</div>
                <div class="col-65">0583A</div>
                <div class="clearer"></div>
                <div class="col-35">Year:</div>
                <div class="col-65">1976</div>
                <div class="clearer"></div>
                ...
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://en.wikipedia.org/wiki/Intel_8080">Wikipedia</a></div>
            </div>
        </p>
    </div>
</div>
<div class="project-box-group">
    <div class="project-box-left">
        ...
        <p>
            <div class="row">
                <div class="col-35">Model:</div>
                <div class="col-65">D8086</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">16 bits / x86</div>
                <div class="clearer"></div>
                <div class="col-35">Frequency:</div>
                <div class="col-65">5.00 MHz</div>
                <div class="clearer"></div>
                <div class="col-35">Serial:</div>
                <div class="col-65">7251D</div>
                <div class="clearer"></div>
                <div class="col-35">Year:</div>
                <div class="col-65">1980</div>
                <div class="clearer"></div>
                ...
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://en.wikipedia.org/wiki/Intel_8086">Wikipedia</a></div>
            </div>
        </p>
    </div>
    <div class="project-box-right">
        ...
        <p>
            <div class="row">
                <div class="col-35">Model:</div>
                <div class="col-65">C80186-3</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">16 bits / x86</div>
                <div class="clearer"></div>
                <div class="col-35">Frequency:</div>
                <div class="col-65">8MHz</div>
                <div class="clearer"></div>
                <div class="col-35">Serial:</div>
                <div class="col-65">S40142</div>
                <div class="clearer"></div>
                <div class="col-35">Year:</div>
                <div class="col-65">1983</div>
                <div class="clearer"></div>
                <div class="col-35">Origin:</div>
                <div class="col-65">Unknown</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://en.wikipedia.org/wiki/Intel_80186">Wikipedia</a></div>
            </div>
        </p>
    </div>
</div>
    ...
    <div class="project-box-left">
        ...
        <p>
            <div class="row">
                ...
                <div class="clearer"></div>
                <div class="col-35">Serial:</div>
                <div class="col-65">S4985</div>
                <div class="clearer"></div>
                <div class="col-35">Year:</div>
                <div class="col-65">1987</div>
                <div class="clearer"></div>
                <div class="col-35">Origin:</div>
                <div class="col-65">Unknown</div>
                <div class="clearer"></div>
    ...
    <div class="project-box-right">
        ...
        <p>
            <div class="row">
                ...
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://en.wikipedia.org/wiki/Intel_80286">Wikipedia</a></div>
            </div>
        </p>
    </div>
</div>
<div class="project-box-group">
    <div class="project-box-left">
        ...
        <p>
            <div class="row">
                <div class="col-35">Model:</div>
                <div class="col-65">A808386DX-20 IV</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits / x86 (IA-32)</div>
                <div class="clearer"></div>
                <div class="col-35">Frequency:</div>
                <div class="col-65">20MHz</div>
                <div class="clearer"></div>
                <div class="col-35">Serial:</div>
                <div class="col-65">L9341099</div>
                <div class="clearer"></div>
                <div class="col-35">Year:</div>
                <div class="col-65">1999</div>
                <div class="clearer"></div>
                <div class="col-35">Origin:</div>
                <div class="col-65">Unknown</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://en.wikipedia.org/wiki/Intel_80386">Wikipedia</a></div>
            </div>
        </p>
    </div>
    <div class="project-box-right">
        ...
        <p>
            <div class="row">
                <div class="col-35">Model:</div>
                <div class="col-65">Unknown / Unreadable</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits / x86 (IA-32)</div>
                <div class="clearer"></div>
                ...
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://en.wikipedia.org/wiki/Intel_80486">Wikipedia</a></div>
            </div>
        </p>
    </div>
</div>
<div class="project-box-group">
    <div class="project-box-left">
        ...
        <p>
            <div class="row">
                <div class="col-35">Model:</div>
                <div class="col-65">XPC603EFE117MJ</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits / PPC</div>
                <div class="clearer"></div>
                <div class="col-35">Frequency:</div>
                <div class="col-65">117Mhz, 133MHz or 166MHz</div>
                <div class="clearer"></div>
                <div class="col-35">Serial:</div>
                <div class="col-65">03F19T QEQR9702</div>
                <div class="clearer"></div>
                <div class="col-35">Year:</div>
                <div class="col-65">Between 1996 and 1998</div>
                <div class="clearer"></div>
                <div class="col-35">Origin:</div>
                <div class="col-65">Apple PowerBook 1400/CS</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://en.wikipedia.org/wiki/PowerPC_600">Wikipedia</a></div>
            </div>
        </p>
    </div>
    <div class="project-box-right">
        ...
        <p>
            <div class="row">
                <div class="col-35">Model:</div>
                <div class="col-65">XPC750 ARX266SE</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits / PPC</div>
                <div class="clearer"></div>
                <div class="col-35">Frequency:</div>
                <div class="col-65">266 MHz</div>
                <div class="clearer"></div>
                <div class="col-35">Serial:</div>
                <div class="col-65">72h30e dsd9840D</div>
                <div class="clearer"></div>
                <div class="col-35">Year:</div>
                <div class="col-65">1999</div>
                <div class="clearer"></div>
                <div class="col-35">Origin:</div>
                <div class="col-65">Apple iMac G3 rev. C</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://en.wikipedia.org/wiki/PowerPC_G3">Wikipedia</a></div>
            </div>
        </p>
    </div>
</div>
<div class="project-box-group">
    <div class="project-box-left">
        ...
        <p>
            <div class="row">
                <div class="col-35">Model:</div>
                <div class="col-65">XPC7455 RX933PC</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits / PPC</div>
                <div class="clearer"></div>
                <div class="col-35">Frequency:</div>
                <div class="col-65">Unknown (between 466MHz and 867MHz)</div>
                <div class="clearer"></div>
                <div class="col-35">Serial:</div>
                <div class="col-65">51L96C DDB0209A</div>
                <div class="clearer"></div>
                <div class="col-35">Year:</div>
                <div class="col-65">2001</div>
                <div class="clearer"></div>
                <div class="col-35">Origin:</div>
                <div class="col-65">Apple PowerMac G4</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://en.wikipedia.org/wiki/PowerPC_G4">Wikipedia</a></div>
            </div>
        </p>
    </div>
    <div class="project-box-right">
        ...
        <p>
            <div class="row">
                <div class="col-35">Model:</div>
                <div class="col-65">XSC7400 RX450MG</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits / PPC</div>
                <div class="clearer"></div>
                <div class="col-35">Frequency:</div>
                <div class="col-65">500MHz</div>
                <div class="clearer"></div>
                <div class="col-35">Serial:</div>
                <div class="col-65">86J87W DXK9942A</div>
                <div class="clearer"></div>
                <div class="col-35">Year:</div>
                <div class="col-65">2001</div>
                <div class="clearer"></div>
                <div class="col-35">Origin:</div>
                <div class="col-65">Apple PowerMac G4 Cube</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://en.wikipedia.org/wiki/PowerPC_G4">Wikipedia</a></div>
            </div>
...
<div class="project-box-group">
    <div class="project-box-left">
        ...
        <p>
            <div class="row">
                <div class="col-35">Model:</div>
                <div class="col-65">AHL1200DHT3B</div>
                <div class="clearer"></div>
                <div class="col-35">Architecture:</div>
                <div class="col-65">32 bits / x86</div>
                <div class="clearer"></div>
                <div class="col-35">Frequency:</div>
                <div class="col-65">1200MHz</div>
                <div class="clearer"></div>
                <div class="col-35">Serial:</div>
                <div class="col-65">Y7721140077</div>
                <div class="clearer"></div>
                <div class="col-35">Year:</div>
                <div class="col-65">Unknown (introduced in 2001)</div>
                <div class="clearer"></div>
                <div class="col-35">Origin:</div>
                <div class="col-65">Unknown</div>
                <div class="clearer"></div>
                <div class="col-35">Infos:</div>
                <div class="col-65"><a href="http://en.wikipedia.org/wiki/Athlon">Wikipedia</a></div>
            </div>
        </p>
    </div>
</div>
<a name="other-accessories"></a>
    ...
    <div class="project-box-left">
        ...
        <p>
            <ul>
                ...
                <li>Apple - LaserWriter IISC</li>
                <li>Apple - Color Style Writer 2400</li>
                <li>Epson - Stylus 1520</li>
                <li>Canon - Pixma 4200</li>
                <li>Digital DECLaser 1151</li>
            </ul>
        </p>
    </div>
    <div class="project-box-right">
        ...
        <p>
            <ul>
                ...
                <li>Apple - 5.25 Drive</li>
                <li>Apple - UniDisk</li>
                <li>Apple - Disk IIc</li>
                <li>HP - Jetstore 2000</li>
                <li>Syquest - 200 / 44</li>
                <li>Topdrive 44</li>
            </ul>
        </p>
    </div>
